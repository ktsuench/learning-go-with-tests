...
import (
	...
	clockface "github.com/ktsuench/learning-go-with-tests/src/01-fundamentals/15-maths/v2"
)
...
func secondHandPoint(t time.Time) Point {
	return angleToPoint(clockface.secondsInRadians(t))
}

func minuteHandPoint(t time.Time) Point {
	return angleToPoint(clockface.minutesInRadians(t))
}

func hourHandPoint(t time.Time) Point {
	return angleToPoint(clockface.hoursInRadians(t))
}

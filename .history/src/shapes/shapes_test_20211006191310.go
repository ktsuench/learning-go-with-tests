...
func TestPerimeter(t *testing.T) {
	perimeterTests := []struct {
		...
		{shape: Rectangle{Width: 10.0, Height: 5.0}, hasPerimeter: 30.0},
		{shape: Circle{Radius: 10.0}, hasPerimeter: 62.83185307179586},
		{shape: Triangle{Base: 12.0, Height: 6.0}, hasPerimeter: 36.0},
	}
